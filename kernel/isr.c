...
void isr0()
{
    printk(exception_messages[0]);
    asm("hlt");    
}
void isr1()
{
    printk(exception_messages[1]);    
    asm("hlt");
}
void isr2()
{
    printk(exception_messages[2]);    
    asm("hlt");
}
void isr3()
{
    printk(exception_messages[3]);    
    asm("hlt");
}
void isr4()
{
    printk(exception_messages[4]);    
    asm("hlt");
}
void isr5()
{
    printk(exception_messages[5]);    
    asm("hlt");
}
void isr6()
{
    printk(exception_messages[6]);    
    asm("hlt");
}
void isr7()
{
    printk(exception_messages[7]);    
    asm("hlt");
}
void isr8()
{
    printk(exception_messages[8]);    
    asm("hlt");
}
void isr9()
{
    printk(exception_messages[9]);    
    asm("hlt");
}
void isr10()
{
    printk(exception_messages[10]);    
    asm("hlt");
}
void isr11()
{
    printk(exception_messages[11]);    
    asm("hlt");
}
void isr12()
{
    printk(exception_messages[12]);    
    asm("hlt");
}
void isr13()
{
    printk(exception_messages[13]);    
    asm("hlt");
}
void isr14()
{
    printk(exception_messages[14]);    
    asm("hlt");
}
void isr15()
{
    printk(exception_messages[15]);    
    asm("hlt");
}
void isr16()
{
    printk(exception_messages[16]);    
    asm("hlt");
}
void isr17()
{
    printk(exception_messages[17]);    
    asm("hlt");
}
void isr18()
{
    printk(exception_messages[18]);    
    asm("hlt");
}
void isr19()
{
    printk(exception_messages[19]);    
    asm("hlt");
}
void isr20()
{
    printk(exception_messages[20]);    
    asm("hlt");
}
void isr21()
{
    printk(exception_messages[21]);    
    asm("hlt");
}
void isr22()
{
    printk(exception_messages[22]);    
    asm("hlt");
}
void isr23()
{
    printk(exception_messages[23]);    
    asm("hlt");
}
void isr24()
{
    printk(exception_messages[24]);    
    asm("hlt");
}
void isr25()
{
    printk(exception_messages[25]);    
    asm("hlt");
}
void isr26()
{
    printk(exception_messages[26]);    
    asm("hlt");
}
void isr27()
{
    printk(exception_messages[27]);    
    asm("hlt");
}
void isr28()
{
    printk(exception_messages[28]);    
    asm("hlt");
}
void isr29()
{
    printk(exception_messages[29]);    
    asm("hlt");
}
void isr30()
{
    printk(exception_messages[30]);    
    asm("hlt");
}
void isr31()
{
    printk(exception_messages[31]);    
    asm("hlt");
}
